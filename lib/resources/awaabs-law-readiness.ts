...
export const awaabsLawReadiness: Resource = {
  ...
  blocks: [
    ...
    {
      type: "paragraph",
      text: "Haven AMS was built around exactly the evidence discipline Awaab's Law demands. Surveys are captured offline-first, so a surveyor working in a basement flat or a dead-signal stairwell — precisely where damp is worst — loses nothing; drafts and photos persist on the device and sync when a connection returns.",
    },
    {
      type: "bullets",
      items: [

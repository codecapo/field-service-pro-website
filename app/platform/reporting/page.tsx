  ...
  return (
    <>
      <header className="relative overflow-hidden border-b border-border">
        ...
        <Container className="relative py-20 md:py-24">
          <div className="grid items-center gap-12 lg:grid-cols-[0.8fr_1.2fr]">
            ...
            <ScaledBrowser url="app.fieldservicepro.example/reporting">
              <DashboardPanel />
            </ScaledBrowser>
          </div>
        </Container>
      ...
      <FeatureShowcase
        ...
        visual={
          <ScaledBrowser url="app.fieldservicepro.example/reporting/decent-homes">
            <DashboardPanel />
          </ScaledBrowser>
        }
      />
      ...
      <FeatureShowcase
        ...
        visual={
          <ScaledBrowser url="app.fieldservicepro.example/reporting/exports">
            <DashboardPanel />
          </ScaledBrowser>
        }
      />
